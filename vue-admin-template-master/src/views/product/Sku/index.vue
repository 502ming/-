<template>
  <div>
    ...
    <!-- 抽屉 -->
    <el-drawer :visible.sync="show" :show="false" size="50%">
      <el-row>
        <el-col :span="5">
          <div>名称</div>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="16">
          ...
          <el-tag type="success" style="margin=right:10px" v-for="(attr,index) in skuInfo.skuAttrValueList"
            :key="attr.id">{{ attr.attrId }}-{{ attr.ValueId }}</el-tag>
