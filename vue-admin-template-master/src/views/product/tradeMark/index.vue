<template>
  <div>
    ...
    <el-table style="width:100%" border :data="list">
      ...
      <el-table-column prop="prop" label="商标" width="width">
    ...
    <el-pagination :total="99" :current-page="5" :page-size="limit" @current-change="getPageList"
      @size-change="handleSizeChange" :page-sizes="[3, 5, 10]"
      ...
      <el-form style="width:80%" :model="tmForm" :rules="rules" ref="ruleForm">
        ...
        <el-form-item label="LOGO" label-width="100px" prop="logoUrl">
          <el-upload class="avatar-uploader" action="/dev-api/admin/product/fileUpload"
            ...
            <div slot="tip" class="el-upload__tip">只能上传jpg/png格式,不能超过500KB</div>
          </el-upload>
        </el-form-item>
      </el-form>
